...
async def subscribe_and_sync_tags(client, sync_lock=None):
    """
    ...
    print("🚀 Initializing Tag PubSub subscription pipeline...")
    ...
    subscription = await client.create_subscription(500, handler_instance)
